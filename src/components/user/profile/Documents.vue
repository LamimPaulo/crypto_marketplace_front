<template>
  <div>
    <div class="post-box">
      ...
      <div class="post-media id_doc"></div>
    ...
    <div class="post-box">
      ...
      <div class="post-media seg_selfie"></div>
...
<style scoped>
  .id_doc {
    background-image: url('../../../assets/img/icons/profile_id.png');
    background-size: 80px;
    background-repeat: no-repeat;
  }
  .seg_selfie {
    background-image: url(../../../assets/img/icons/seg_selfie.png);
    background-size: 80px;
    background-repeat: no-repeat;
  }
</style>
