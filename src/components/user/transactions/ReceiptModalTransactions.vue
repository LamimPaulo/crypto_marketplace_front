  ...
  <div name="vue-modal-fade">
    <div class="receipt-modal-backdrop">
        ...
        <div class="btn-group btn-group-lg btn-group-vertical topright" role="group" aria-label="Controls">
          <button type="button" class="btn btn-secondary" @click="closeThisModal"><i class="os-icon os-icon-close" style="font-size: 1.9rem;"></i></button>
          <button type="button" class="btn btn-secondary" @click="print()"><i class="os-icon os-icon-printer" style="font-size: 1.9rem;"></i></button>
        </div>
         ...
         <div id="receipt" class="receipt" v-if="transaction.coin" ref="printReceipt">
          ...
          <div class="receipt__cart">
            <div class="d-flex justify-content-end">
              <strong class="pr-1">Status:</strong> <span>{{ transaction.statusName }}</span>
            </div>
            ...
            <ul class="receipt__cart-list">
              <li class="receipt__cart-item">
                <span class="receipt__item-name">Fee:</span>
                <span class="receipt__item-price">{{ transaction.feeRounded }}</span>
              </li>
    
              <li class="receipt__cart-item">
                <span class="receipt__item-name">Taxas:</span>
                <span class="receipt__item-price">{{ transaction.taxRounded }}</span>
              </li>
              
              <li class="receipt__cart-item">
                <span class="receipt__cart-total">Valor</span>
                <span class="receipt__item-price">{{ transaction.amountRounded }}</span>
              </li>
            </ul>
