      ...
      <div id="receipt" class="receipt" v-if="transaction.coin" ref="printReceipt">
        ...
        <div class="receipt__cart">
          ...
          <ul class="receipt__cart-list">
            <li class="receipt__cart-item" v-if="transaction.toAddress">
              <span class="receipt__item-name">Para:</span>
              <span class="receipt__item-price">{{ transaction.toAddress}}</span>
            </li>
            ...
            <li class="receipt__cart-item" v-if="transaction.fee>0">
              ...
              <span class="receipt__item-price"
                    v-else> {{transaction.coin.shortname}} {{ transaction.feeRounded }}</span>
            </li>
            ...
            <li class="receipt__cart-item" v-if="transaction.tax>0">
              ...
              <span class="receipt__item-price"
                    v-else> {{transaction.coin.shortname}} {{ transaction.taxRounded }}</span>
            </li>
            ...
            <li class="receipt__cart-item">
              ...
              <span class="receipt__item-price"
                    v-else> {{transaction.coin.shortname}} {{ transaction.amountRounded }}</span>
            </li>
            ...
            <li class="receipt__cart-item">
              ...
              <span class="receipt__item-price"
                    v-else> {{transaction.coin.shortname}} {{ transaction.totalRounded }}</span>
            </li>
          </ul>
