                                    ...
                                    <div class="element-wrapper mb-0 pb-0 pt-0">
                                        ...
                                        <div class="element-box">
                                            ...
                                            <div class="element-info mb-0 ">
                                                <h5 class="element-inner-header">
                                                    Ticket #{{ ticket_message.id }} - {{ticket_message.subject}} <span :class="'ml-2 py-2 px-2 badge badge-'+ticket_message.statusClass"> {{ticket_message.statusName}} </span>
                                            ...
                                            <div class="mt-4" v-for="(msg,i) in ticket_message.messages">
                                                ...
                                                <div :class="msg.user.email!==user.email ? 'd-block badge badge-warning py-4 px-2 text-right' : 'd-block badge badge-default py-4 px-2 text-left' ">
                                                    {{ msg.message }}
                                                </div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-lightborder table-striped">
                                                            ...
                                                            <tr v-for="ticket in tickets.data">
                                                                ...
                                                                <td>
                                                                    <span :class="'py-2 px-2 badge badge-'+ticket.statusClass">
                                                                        {{ticket.statusName}}
                                                                    </span>
                                                                </td>
