    ...
    <div class="element-box">
      ...
      <form @submit.prevent="sendTransaction">
        <div class="row">
          <div class="col-sm-6 col-lg-3">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="Quantidade" required
                     @input="retrieveFee" v-model="transaction.amount" type="text">
            </div>
          </div>
          ...
          <div class="col-sm-6 col-lg-2">
            <div class="form-group">
              ...
              <select class="form-control" name="" id="" v-model="transaction.priority" @change="retrieveFee">
        ...
        <div class="form-buttons-w text-right">
          ...
          <button class="btn btn-primary" :disabled='!isFilled' @click.prevent="showTokenPinModal('sendTransaction', 5)"
                  type="button"> Enviar
          </button>
        </div>
      </form>
...
<script>
  ...
  export default {
    ...
    methods: {
      retrieveFee: debounce(function (e) {
