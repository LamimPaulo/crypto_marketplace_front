  ...
  <div>
    ...
    <div class="menu-mobile menu-activated-on-click color-scheme-dark">
      <div class="mm-logo-buttons-w">
        <a class="mm-logo" href="/dashboard"><img src="https://s3.amazonaws.com/navi-public/api/logo-light.png"></a>
    ...
    <div
      ...
      <div class="logo-w">
        <a class="logo" href="/dashboard">
          <img src="https://s3.amazonaws.com/navi-public/api/logo.png" class="logo">
          <div class="logo-label">Capital &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
        </a>
      </div>
