<template>
  <div>
    <div class="top-bar" style="background:#005193">
        <!--------------------START - Top Menu Controls-------------------->
        <div class="logo-w">
            <a class="mm-logo" href="/dashboard"><img src="https://s3.amazonaws.com/navi-public/api/clients/3/logosemfundo2.png"></a>
        </div>
                        ...
                        <li>
                            <a href="#">
                                <div class="user-avatar-w">
                                    <img alt="" src="http://localhost:8080/static/img/avatar-dev.05e7d41.png">
                                </div>
