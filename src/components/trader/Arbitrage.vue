    ...
    <div class="content-box">
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-3 col-xxl-3">
              <a class="element-box el-tablo centered trend-in-corner smaller mb-3" href="#">
                ...
                <div class="value">
                  <button class="btn btn-success" @click="showModal('invest')" type="button"> Investir</button>
                  <button class="btn btn-grey" @click="showModal('draft')" v-if="investment_data.user_profit>0"
                          type="button"> Saque
                  </button>
                  <button class="btn btn-grey" disabled v-if="investment_data.user_profit<=0" type="button"> Saque
                  </button>
                </div>
              </a>
            </div>
      ...
      <modal v-show="isModalVisible" >
          ...
          <div class="os-tabs-w">
            <div class="os-tabs-controls os-tabs-complex">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item col-md-6 text-center">
                  <a :class="tabclass_draft" href="#" v-if="investment_data.user_profit>0" @click="showDraftWindow">
        ...
        <template slot="body">
          <div v-show="isInvestWindowVisible">
            <form>
              ...
              <div class="form-group row mb-0">
                <label class="col-form-label col-sm-4"> Fonte</label>
                <div class="col-sm-8">
                  <div class="pt-btn" v-if="user.country_id===31">
                    <button type="button" class="btn btn-grey btn-md"
                            v-if="investment_in.coin !== 2"
                            @click="setSourceCoin(2)">
                      R$
                    </button>
                  ...
                  <div class="pt-btn" v-if="user.country_id!==31">
                    <button type="button" class="btn btn-grey btn-md"
                            v-if="investment_in.coin !== 3"
                            @click="setSourceCoin(3)">
                      USD
                    </button>
                    <button type="button" class="btn btn-primary btn-md"
                            v-if="investment_in.coin === 3"
                  ...
                  <div class="pt-btn">
                    <button type="button" class="btn btn-grey btn-md"
                            v-if="investment_in.coin !== 1"
                            @click="setSourceCoin(1)">
                      BTC
                    </button>
                    <button type="button" class="btn btn-primary btn-md"
                            v-if="investment_in.coin === 1"
                ...
                <div class="col-sm-8">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <div class="input-group-text" v-if="investment_in.coin===1">
                        BTC
                      </div>
                      <div class="input-group-text" v-if="investment_in.coin===2">
                        BRL
                      </div>
                      <div class="input-group-text" v-if="investment_in.coin===3">
                        USD
                      </div>
                    </div>
                  </div>
            ...
            <form>
                ...
                <div class="col-sm-8">
                  <div class="input-group">
                    <input id="amount_out" class="form-control" type="text" required
                           v-model="investment_out.amount" min="0" :disabled="investment_out.operation_type===6">
                    <div class="input-group-append">
              ...
              <div class="row mt-5 mb-0">
                <div class="col-12 text-center">
                  <button class="btn btn-grey" type="button" @click="closeModal"> Fechar</button>
                  <button class="btn btn-primary" type="button"
                          @click.prevent="showPinModal('draftInvestment')"> Confirmar
                  </button>
                </div>
              </div>
        ...
        <template slot="footer">
          <span v-if="isInvestWindowVisible"> Taxa de Corretagem: {{ investment_data.brokerage_fee }} <i class="os-icon os-icon-percent"></i></span>
          <span v-if="isDraftWindowVisible"> Taxa de Corretagem: 0 <i class="os-icon os-icon-percent"></i></span>
        </template>
      </modal>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      draftInvestment() {
        this.$store.dispatch('draftInvestment', {
      ...
      handlePinData(data) {
        ...
        if (data.method === 'draftInvestment') {
          this.draftInvestment()
        }
      },
    },
    mounted() {
